...
local snd_pilot
local snd_best 
local snd_fin  ="/SOUNDS/fr/Cfin.wav"
local v_topDepart
...
tPage.init = function()
	...
	snd_start	  = v_start_top == 0 										and "/SOUNDS/fr/Cstart.wav" or nil
	snd_topDepart = v_start_top == 2 										and "/SOUNDS/fr/CtopCD.wav" or nil
	snd_pilot 	  = (v_start_top ~= 0 and tonumber(t_Params.snd_pilot)>0) 	and "/SOUNDS/fr/Cpilot.wav" or nil
	snd_best 	  = tonumber(t_Params.snd_best)>0 							and "/SOUNDS/fr/Cbest.wav"  or nil
